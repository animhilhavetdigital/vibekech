...
/* ---------------- Hero ---------------- */
const navItems = ["Our story", "Tours & Safaris", "Transfers", "Custom Itinerary", "Inquiries"];
          ...
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 lg:col-span-8">
              <h1
                ...
                style={{ color: "#E1E0CC" }}
              >
                <WordsPullUp text="Morocco" showAsterisk />
              </h1>
            </div>
            ...
            <div className="col-span-12 flex flex-col gap-5 pb-6 lg:col-span-4 lg:pb-10">
              ...
              >
                True Kech Tours is a curated network of Moroccan explorers, local guides and desert storytellers bound by passion to unlock unforgettable moments through authentic journeys.
              </motion.p>

              <motion.a
                href="#morocco-calculator"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
